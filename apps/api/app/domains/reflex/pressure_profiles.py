...
PRESSURE_PROFILES: dict[str, dict] = {
    PressureLevel.RELAXED.value: {
        ...
        "label_ja": "ゆっくり",
        "timer_limit_ms": 6000,
        "description": "Thong thả, tập trung độ chính xác.",
        "difficulty": "easy",
    },
    PressureLevel.NORMAL.value: {
        ...
        "label_ja": "普通",
        "timer_limit_ms": 4000,
        "description": "Nhịp tự nhiên, cân bằng tốc độ & chính xác.",
        "difficulty": "normal",
    },
    PressureLevel.FAST.value: {
        ...
        "label_ja": "速め",
        "timer_limit_ms": 3000,
        "description": "Tăng áp lực, luyện phản xạ nhanh.",
        "difficulty": "normal",
    },
    PressureLevel.REFLEX.value: {
        ...
        "label_ja": "瞬発",
        "timer_limit_ms": 2500,
        "description": "Phản xạ tức thì, như hội thoại thực.",
        "difficulty": "hard",
    },
    PressureLevel.EXTREME.value: {
        ...
        "label_ja": "超速",
        "timer_limit_ms": 1800,
        "description": "Thử thách giới hạn, không dành cho beginner.",
