...
# 1. Bulletproof UniversalFurigana.tsx
BULLETPROOF_FURIGANA = """\"use client\";
...
with open(r"E:\SpeakingTraining\apps\web\components\japanese\UniversalFurigana.tsx", "w", encoding="utf-8") as f:
    f.write(BULLETPROOF_FURIGANA.strip() + "\n")
print("UniversalFurigana.tsx written with Micro-stacking architecture!")
