...
export type KeybindingCategory = "shadowing" | "speaking" | "keigo" | "pitch" | "drills" | "system";
...
export interface SystemKeybindings {
  ...
  // 5. Drills & Quick Practice (Reflex, Pitch, Situations, Speech)
...
const STORAGE_KEY = "hanasu_system_keybindings_v4";
...
export const ALL_ACTION_DEFINITIONS: ActionDefinition[] = [
  ...
  },
  {
    ...
    category: "pitch",
    categoryLabel: "Phòng Cao Độ",
    description: "Tra cứu 4 loại cao độ Tokyo (Heiban, Atamadaka...), Cặp từ & Vô thanh hóa",
...
export function GlobalKeybindingsModal({ isOpen, onClose }: GlobalKeybindingsModalProps) {
  const [activeTab, setActiveTab] = useState<KeybindingCategory>("pitch");
...
print("Keybindings updated for Pitch Lab!")
